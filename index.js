...
// Generated by Discord Bot Generator
// ============================================================
// Requirements: npm install discord.js
// Usage: BOT_TOKEN=MTUyOTA4MzIzMzc3NjY5NzQ3NQ.GQLU_v.Vv6EZwE6FTygaZ7DtRY2nAzyYC17FEjKb3SiOg node accountgen.js
// ============================================================
...
// ─────────────────────────────────────────
// SERVICES & STOCK
// Edit stock arrays to add or remove accounts.
// ─────────────────────────────────────────
const SERVICES = [
...
const cooldowns = new Map(); // key: userId:serviceId → timestamp
...
client.on("messageCreate", async (message) => {
  ...
  if (command === "bgen") {
    ...
    if (!query) {
      return message.reply(`Usage: ${PREFIX}bgen <service name>\nExample: ${PREFIX}bgen netflix`);
    }
